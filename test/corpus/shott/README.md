...
The `.rzk` files intentionally stay in Unicode notation, matching how these
judgements are written in sHoTT. YAML metadata only records expectations and
does not rewrite the source file syntax.
